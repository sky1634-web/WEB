    ...
    <div class="row">
      ...
      <!--<div class="col-md-4">
       ...
       <div class="col-md-4 offset-md-4">
        ...
        <?php
        /*news("Росстат примет участие в Международной конференции «Опыт и будущие вызовы в измерении доходов и благосостояния в странах Восточной Европы и СНГ».

Мероприятие состоится 17-18 сентября в Москве. Организаторы - Международная ассоциация по исследованию доходов и благосостояния (IARIW) совместно с Национальным исследовательским университетом «Высшая школа экономики» (НИУ ВШЭ). Это первая конференция, организованная IARIW в странах бывшего Советского Союза.","https://www.hse.ru/iariw/");
        */
        ?> 
